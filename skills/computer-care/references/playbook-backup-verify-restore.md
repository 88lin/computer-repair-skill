...
- Create a small test file in a known location (e.g., `~/Desktop/computer-care-backup-test.txt` with a timestamp).
...
- Delete `~/Desktop/computer-care-backup-test.txt` if created.
