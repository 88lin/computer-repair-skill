...
- **Gateway works, 8.8.8.8 fails** → ISP or upstream issue. Try a different DNS: `mac_ping` to `1.1.1.1`. If that also fails, it's an ISP outage — nothing the host Agent can fix locally.
